...
function Api() {
  ...
  async function getSong(query){
    ...
    return (
      ...
      <div className="w-screen min-h-screen bg-gradient-to-r from-zinc-800 to-zinc-950 py-2"> 
      ...
      <div className="w-screen min-h-screen bg-gradient-to-r from-zinc-800 to-zinc-950 py-8 flex flex-col items-center justify-center">
        ...
        <form onSubmit={handleSearch} className="flex gap-2">
          ...
          className="flex-grow p-3 rounded-lg border border-zinc-50 bg-zinc-50 font-bold text-black placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-150"
          />
          <button
          type="submit"
          disabled={isLoading}
      ...
      <footer class="bg-neutral-primary-soft rounded-base shadow-xs border border-zinc-600 m-4">
